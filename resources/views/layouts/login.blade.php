...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <a class="navbar-brand" href="login">web電卓</a>
  <div class="navbar-brand" href="#">@yield('title')</div>
  ...
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
    <div class="navbar-nav">
      <a class="nav-item nav-link" href={{url("/login")}}>ログイン<span class="sr-only">(現位置)</span></a>
